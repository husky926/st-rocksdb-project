...
class Block {
 public:
  ...
  IndexBlockIter* NewIndexIterator(
      ...
      bool decode_index_st_meta_tail = false);
...
class IndexBlockIter final : public BlockIter<IndexValue> {
 public:
  ...
  void Initialize(
    ...
    decode_index_st_meta_tail_ = decode_index_st_meta_tail;
 ...
 private:
  ...
  bool decode_index_st_meta_tail_ = false;
