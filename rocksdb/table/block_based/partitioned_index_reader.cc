  ...
  if (!partition_map_.empty()) {
    ...
    it = NewTwoLevelIterator(
        ...
        index_block.GetValue()->NewIndexIterator(
            ...
            user_defined_timestamps_persisted(), nullptr,
            rep->table_options.index_block_search_type,
            rep->table_options.experimental_spatio_temporal_meta_in_index_value));
  } else {
...
Status PartitionIndexReader::CacheDependencies(
  ...
  index_block.GetValue()->NewIndexIterator(
      ...
      nullptr, rep->table_options.index_block_search_type,
      rep->table_options.experimental_spatio_temporal_meta_in_index_value);
  ...
  if (uncache_aggressiveness > 0) {
    ...
    if (!partition_map_.empty()) {
      ...
      top_level_block.GetValue()->NewIndexIterator(
          ...
          user_defined_timestamps_persisted(), nullptr,
          table()->get_rep()->table_options.index_block_search_type,
          table()
              ->get_rep()
              ->table_options.experimental_spatio_temporal_meta_in_index_value);
