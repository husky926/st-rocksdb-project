...
struct MutableCFOptions {
  ...
  explicit MutableCFOptions(const ColumnFamilyOptions& options)
      : write_buffer_size(options.write_buffer_size),
        ...
        experimental_compaction_event_time_split(
            options.experimental_compaction_event_time_split),
        experimental_compaction_event_time_max_span(
            options.experimental_compaction_event_time_max_span),
        experimental_compaction_event_time_bucket_width(
            options.experimental_compaction_event_time_bucket_width),
        experimental_compaction_event_time_min_keys_per_file(
            options.experimental_compaction_event_time_min_keys_per_file),
        experimental_compaction_event_time_max_point_keys(
  ...
  MutableCFOptions()
      : write_buffer_size(0),
        ...
        experimental_compaction_event_time_split(false),
        experimental_compaction_event_time_max_span(0),
        experimental_compaction_event_time_bucket_width(0),
        experimental_compaction_event_time_min_keys_per_file(0),
        experimental_compaction_event_time_max_point_keys(0),
  ...
  bool experimental_compaction_event_time_split;
  uint32_t experimental_compaction_event_time_max_span;
  uint32_t experimental_compaction_event_time_bucket_width;
  uint32_t experimental_compaction_event_time_min_keys_per_file;
  uint32_t experimental_compaction_event_time_max_point_keys;
