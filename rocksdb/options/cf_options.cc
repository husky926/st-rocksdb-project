...
void MutableCFOptions::Dump(Logger* log) const {
  ...
  ROCKS_LOG_INFO(log, "          experimental_mempurge_threshold: %f",
                 experimental_mempurge_threshold);
  ROCKS_LOG_INFO(log, " experimental_compaction_event_time_split: %d",
                 static_cast<int>(experimental_compaction_event_time_split));
  ROCKS_LOG_INFO(log,
                 " experimental_compaction_event_time_max_span: %" PRIu32,
                 experimental_compaction_event_time_max_span);
  ROCKS_LOG_INFO(
      log, " experimental_compaction_event_time_bucket_width: %" PRIu32,
      experimental_compaction_event_time_bucket_width);
  ROCKS_LOG_INFO(
      log, " experimental_compaction_event_time_min_keys_per_file: %" PRIu32,
      experimental_compaction_event_time_min_keys_per_file);
  ROCKS_LOG_INFO(
      log, " experimental_compaction_event_time_max_point_keys: %" PRIu32,
      experimental_compaction_event_time_max_point_keys);
