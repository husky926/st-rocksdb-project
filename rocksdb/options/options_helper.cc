...
void UpdateColumnFamilyOptions(const MutableCFOptions& moptions,
  ...
  cf_opts->experimental_compaction_event_time_split =
      moptions.experimental_compaction_event_time_split;
  cf_opts->experimental_compaction_event_time_max_span =
      moptions.experimental_compaction_event_time_max_span;
  cf_opts->experimental_compaction_event_time_bucket_width =
      moptions.experimental_compaction_event_time_bucket_width;
  cf_opts->experimental_compaction_event_time_min_keys_per_file =
      moptions.experimental_compaction_event_time_min_keys_per_file;
  cf_opts->experimental_compaction_event_time_max_point_keys =
      moptions.experimental_compaction_event_time_max_point_keys;
