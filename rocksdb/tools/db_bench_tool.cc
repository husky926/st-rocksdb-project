...
DEFINE_bool(
    spatio_temporal_meta_in_index_value,
    ROCKSDB_NAMESPACE::BlockBasedTableOptions()
        .experimental_spatio_temporal_meta_in_index_value,
    "EXPERIMENTAL: append spatio-temporal tail to primary index values "
 ...
 private:
  ...
  void InitializeOptionsFromFlags(Options* opts) {
    ...
    if (FLAGS_use_plain_table) {
      ...
      block_based_options.experimental_spatio_temporal_meta_in_index_value =
          FLAGS_spatio_temporal_meta_in_index_value;
